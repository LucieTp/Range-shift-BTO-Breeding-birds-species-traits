...
# years_Velocity <- 1968:2011

nP <- 3

# selected CRU climate variables for winter and summer
...
# 
# # check plots:
# par(mfrow = c(2,1)); plot(tmp_seas.Velocity[["X1968"]]);plot(tmp_seas.Velocity[["X2011"]])
# 
...
write.csv(x = df_rangeshift, file = "data/df_rangeshift_012023.csv")
